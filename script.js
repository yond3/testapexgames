...
        if (chooseUsernameModal) { clearError('chooseUsernameInput'); clearGenericError('genericUsernameError'); chooseUsernameModal.style.display = 'flex'; }
...
    function clearAllErrors() { // Clears errors in BOTH modals

        const errorMessages = document.querySelectorAll('#signInModal .error-message, #chooseUsernameModal .error-message');
...
    if (signInBtn) signInBtn.addEventListener('click', openModal); // Opens the signin/signup modal
...
    // Clear errors on input for all modal fields
...
                        // Save initial username and email to Firestore
...
                                openChooseUsernameModal(); // Fallback to choosing username
...
                                // Redirect to dashboard (Auth state observer on dashboard will handle UI update)
...
                                openChooseUsernameModal(); // Prompt if missing
...
                             openChooseUsernameModal(); // Prompt on error
...
    if(signInBtn) signInBtn.disabled = true;
    ...
    function handleForgotPassword() {
        ...
        displayGenericError('Sending reset email...', 'genericAuthError');
