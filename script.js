...
try {
    ...
    if (signupForm) { /* ... rest of existing signup logic ... */ } else { console.warn("Signup form element not found."); }
    if (loginForm) { /* ... rest of existing login logic ... */ } else { console.warn("Login form element not found."); }

    // --- Save Username Button Listener ---
    if (saveUsernameBtn) { /* ... rest of existing save username logic ... */ } else if (document.getElementById('chooseUsernameModal')) { console.warn("Save Username button not found, although choose username modal exists."); }
